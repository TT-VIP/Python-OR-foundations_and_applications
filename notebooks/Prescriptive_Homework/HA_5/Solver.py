...
class Solver:
    ...
    def RunGeneticAlgorithm(self, populationSize, generations, matingProb, mutationProb):
        ...
        toolbox.register("indices", self.RNG.choice, range(self.InputData.n), self.InputData.n, replace=False)
...
if __name__ == '__main__':    
    data = InputData("TestInstancesJson/Small/VFR30_5_1_SIST.json") # TestInstances/Small/VFR40_10_3_SIST.txt 
    ...
    solver.RunLocalSearch(
        constructiveSolutionMethod='ROS',
