...
class IteratedGreedy(ImprovementAlgorithm):
    def __init__(self, inputData, numberJobsToRemove, baseTemperature, maxIterations, maxIterationsWithoutImprovement=float('inf'), localSearchAlgorithm = None):
    ...
    def Run(self, currentSolution):
        ...
        while(iteration < self.MaxIterations):
            ...
            if newSolution.Makespan < currentSolution.Makespan:
                ...
                #print(f'Accepted worse solution in iteration {iteration}: {newSolution}')
                currentSolution = newSolution
                ...
                if iterationsWithoutImprovement == self.MaxIterationsWithoutImprovement:
                    print(f'No improvement for {self.MaxIterationsWithoutImprovement} iterations, stopping search.')
                    break
