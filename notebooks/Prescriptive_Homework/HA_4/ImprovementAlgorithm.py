...
class ImprovementAlgorithm:
    ...
    def CreateNeighborhood(self, neighborhoodType, bestCurrentSolution):
        ...
        elif neighborhoodType == 'BlockK1':
            return BlockNeighborhoodK3(self.InputData, bestCurrentSolution.Permutation, self.EvaluationLogic, self.SolutionPool, blockSize=1)
        else:
